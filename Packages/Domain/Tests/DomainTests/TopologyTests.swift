...
struct TopologyTests {
    @Test(arguments: [
        ...
        (SudokuVariant.mini4, 16, 12),
        (SudokuVariant.dodeka12, 144, 36),
        (SudokuVariant.hexadoku16, 256, 48),
        (SudokuVariant.wordoku, 81, 27),
        (SudokuVariant.jigsaw, 81, 27),
        (SudokuVariant.argyle, 81, 27),
        (SudokuVariant.asterisk, 81, 28),
        (SudokuVariant.gattai2, 153, 53),
        (SudokuVariant.gattai3, 225, 79),
        (SudokuVariant.gattai8, 576, 208),
        (SudokuVariant.shogun, 783, 285),
        (SudokuVariant.sumo, 909, 335),
        (SudokuVariant.alphadoku25, 625, 75),
        (SudokuVariant.antiKnight, 81, 27),
        (SudokuVariant.antiKing, 81, 27),
        (SudokuVariant.greaterThan, 81, 27),
        (SudokuVariant.kropki, 81, 27),
